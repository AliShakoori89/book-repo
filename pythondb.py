...
class Sqlite3_db:
    ...
    def create_table(self):
        ...
        self.cur.execute('CREATE TABLE IF NOT EXISTS link(book_bID INTEGER,author_aID INTEGER,FOREIGN KEY (book_bID) REFERENCES book (bID),FOREIGN KEY (author_aID) REFERENCES author (aID))')
        self.conn.commit()
